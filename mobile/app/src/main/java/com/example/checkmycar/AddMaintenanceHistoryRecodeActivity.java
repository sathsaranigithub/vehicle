...
public class AddMaintenanceHistoryRecodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_maintenance_history_recode);
        // Initialize views
    ...
    private void showDatePicker() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(
                AddMaintenanceHistoryRecodeActivity.this,
    ...
    private void saveUpcomingMaintenance(String registrationNumber) {
        ...
        DocumentReference docRef = db.collection("service_maintenance_history").document(registrationNumber);
        ...
        docRef.get().addOnSuccessListener(documentSnapshot -> {
            ...
            docRef.set(new HashMap<String, Object>() {{
                    ...
                    .addOnSuccessListener(aVoid -> {
                        Snackbar.make(findViewById(android.R.id.content), "Service saved successfully.", Snackbar.LENGTH_SHORT).show();
                        progressBar.setVisibility(ProgressBar.GONE); // Hide progress bar after success
                    })
                    .addOnFailureListener(e -> {
                        Snackbar.make(findViewById(android.R.id.content), "Error saving Service details: " + e.getMessage(), Snackbar.LENGTH_LONG).show();
                        Log.e("SaveError", "Error saving Service details: " + e.getMessage());
