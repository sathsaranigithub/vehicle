...
export const myPagesMenu = {
	dashboard: {
		id: 'dashboard',
		text: 'Dashboard',
		path: 'employeepages/dashboard',
		icon: 'Dashboard',
		subMenu: null,
	},
	...
	ManageEmployee: {
		...
		path: '/employeepages/manageemployees',
		icon: 'ManageAccounts',
	},
...
export const accountpagemenu = {
	...
	ManageEmployee: {
		id: 'Manage Cashbook',
		text: 'Manage Cashbook',
		path: '/accountmanager/managecashbook',
		icon: 'MenuBook',
	},
	ViewInvoice: {
		id: 'Manage Invoice',
		text: 'Manage Invoice',
		path: '/accountmanager/manageinvoice',
		icon: 'Receipt',
	},
	ViewEmails: {
		id: 'View Emails',
		text: 'View Emails',
		path: '/accountmanager/viewemails',
		icon: 'Email',
	},
...
export const projectmenu = {
	...
	managebudget: {
		id: 'Manage Budget',
		text: 'Manage Budget',
		path: '/projectmanager/managebudget',
		icon: 'TrendingUp',
	},
	viewemployees: {
		id: 'view employees',
		text: 'View Employees',
		path: '/projectmanager/viewemployees',
		icon: 'People',
	},
	...
	singlePages: {
		...
		subMenu: {
			...
			task: {
				id: 'task',
				text: 'View Task',
				path: 'developer/viewTask',
				icon: 'AddTask',
				subMenu: null,
			},
			leadertask: {
				id: 'leadertask',
				text: 'View Leader Task',
				path: 'developer/leaderTask',
				icon: 'TaskAlt',
				subMenu: null,
			},
		},
